...
1. **_Pangolin exercise_**
   Let's get a little bit of practice with heading and paragraph elements. Copy the [html-exercises-assets/pangolin.txt](html-exercises-assets/pangolin.txt) content into an html file. Please add in the appropriate paragraph and heading elements to recreate what is shown in this image:
...
2. **_Favorite Movies Exercises_**
   It's time to practice working with ordered and unordered lists. Copy the [html-exercises-movies.txt](html-exercises-assets/movies.txt) content into an html file. Please add on to the markup to recreate the two lists in the following image.
